...
- waiting for a reply is still exposed as a special pause primitive instead of as a normal agent action
...
This should be the agent-facing primitive instead of exposing a special pause step
directly.
...
- exposing a special pause primitive as the main authoring primitive
